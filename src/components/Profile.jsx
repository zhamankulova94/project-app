...
const Profile = () => {
 return(
  <div className='content'>
        <div>
          <img src='https://images.unsplash.com/photo-1500622944204-b135684e99fd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bmF0dXJhbHxlbnwwfHwwfHw%3D&w=1000&q=80' />
        </div>
        <div>
